 ...
 * [Static County Maps](./reports/2011/OsdhMaps.html). It was helpful to supplement the previous reports with these county-level maps, in order to for the reader to place statistics in context of a county's geography and demographics.  (Also available as a [pdf](./reports/2011/OsdhMaps.pdf) for printed handouts.)
 * [Animated County Maps](https://raw.githubusercontent.com/OuhscBbmc/OsctrAstonWeber/master/Analysis/Spatial/AnimationImages/AmputationAnimatedRate.gif).  The 5-year longitudinal progression of county amputation rates are animated in this graph.
